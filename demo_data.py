...
Usage:
    cd backend && python3 ../demo_data.py

Or:
    cd backend && python3 -c "import sys; sys.path.insert(0, '.'); exec(open('../demo_data.py').read())"
...
def populate_demo_data():
    ...
    print(f"\nDatabase file: backend/health_smc.db")
    print(f"Start server: python3 backend/main.py")
